...
def main(argv: list[str] | None = None) -> int:
    ...
    from . import operations,policy,retractions,editorial,republish,acceptance,feed_tools,notion_discovery
    for module in (operations,policy,retractions,editorial,republish,acceptance,feed_tools,notion_discovery):
