...
COPY = {
    "zh-TW": {
        ...
        "eyebrow": "來自 g0v 與公民科技社群", "hero_title": "看見社群進展。", "hero_accent": "找到協作起點。",
    ...
    "ko": {
        ...
        "eyebrow": "g0v와 시빅테크 커뮤니티에서", "hero_title": "소식을 나누고,", "hero_accent": "다음을 함께.",
    ...
    "ja": {
        ...
        "eyebrow": "g0v とシビックテックの現場から", "hero_title": "みんなの一歩を、", "hero_accent": "次の協働へ。",
    ...
    "en": {
        ...
        "eyebrow": "From g0v & the civic tech community", "hero_title": "Small updates.", "hero_accent": "Shared possibilities.",
