...
rep0rter 是服務 g0v 公民科技社群的自動新聞系統：採集公開協作紀錄，挑選值得報導的進展，產生四語短報導，再發布到網站、RSS 與 Telegram。
...
每張報導卡包含來源名稱、標題、摘要、圖卡、作者、原文時間、互動數與來源連結；讀者透過外部來源連結閱讀原文。單篇頁額外顯示報導時間、版本與相關來源。英文版使用英文摘要圖卡；其他語言版沿用原文圖卡。
